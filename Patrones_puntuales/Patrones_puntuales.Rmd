...
author: "María Paula Camargo Rincón \nLaura Katherine Martinez Castiblanco"
output:
...
Para fines descriptivos se decidió utilizar un ancho de banda donde se optimizara el error de predicción, el algoritmo consiste en por cada valor de ancho ed banda:
...
El ancho de banda que minimizo mejor el error de predicción.
