...
gamma_mix <- function(h,
  ...
  a*gamma_sph(h,nugget,sill,range)+
  b*gamma_exp(h,nugget,sill,range)+
  c*gamma_gau(h,nugget,sill,range)

}

cov_model <- function(h,
                      nugget,
                      sill,
                      range,
                      a,
...
#Log veroslimlitud compuesta
compLik <- function(par,
                    D,
                    z){
